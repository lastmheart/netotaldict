...
; /* Start:"a:4:{s:4:"full";s:73:"/local/templates/shop/components/bitrix/menu/shop/script.js?1548099920229";s:6:"source";s:59:"/local/templates/shop/components/bitrix/menu/shop/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
$(function(){
    let mainmenu = $('.mainmenu').find('nav');
    if(mainmenu.hasClass('menu_1')){
        mainmenu.scrollLeft(40);
    }
    if(mainmenu.hasClass('menu_2')){
        mainmenu.scrollLeft(180);
    }
...
/* End */
;; /* /local/templates/shop/components/bitrix/menu/shop/script.js?1548099920229*/
